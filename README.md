...
4 -> Operadores matemáticos, desensolvido e compilado no terminal , usar javac e java conforme orientações anteriores ! <br><br>
...
5 -> Laços (For), desensolvido e compilado no terminal , usar javac e java conforme orientações anteriores ! <br><br>
...
6 -> Laços (while), desensolvido e compilado no terminal , usar javac e java conforme orientações anteriores ! <br><br>
...
7 -> Seleção If ; Else ; Else if , desensolvido e compilado no terminal , usar javac e java conforme orientações anteriores ! <br><br>
